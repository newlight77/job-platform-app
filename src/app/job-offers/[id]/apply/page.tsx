...
export default async function ApplyJobPage (props : { params: Params }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/job-offers/${id}/apply/success`)
    } catch (err) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-4">
        <Link href={`/job-offers/${id}`} className="text-blue-600">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end">
            <button
              ...
              onClick={() => router.push(`/job-offers/${id}`)}
            >
              Cancel
            </button>
            <button
